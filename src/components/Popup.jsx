   ...
   Display the price */}
      ...
      <div className="mb-5   continerinput ">
        ...
        <input
          ...
          type="text"
          id="default-input"
          class="bg-gray-50 border inp border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        />
      </div>
        ...
        <div className="mb-5 continerinput">
          ...
          <div className={`relative discontinput ${discountEnabled ? "" : 'opacity-70'}`}>
            <input
              ...
              } pl-10 text-sm inp text-gray-900 border  border-gray-300 rounded-lg bg-gray-50  focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-700 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500`}
            />
